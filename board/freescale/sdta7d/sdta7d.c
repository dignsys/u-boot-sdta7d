...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	MX7D_PAD_EPDC_DATA14__GPIO2_IO14 | MUX_PAD_CTRL(NO_PAD_CTRL),	/* RGMII2_PHY_INT */
	MX7D_PAD_EPDC_DATA15__GPIO2_IO15 | MUX_PAD_CTRL(NO_PAD_CTRL),	/* ENET_RST_B */
};

#define FEC1_RST_GPIO	IMX_GPIO_NR(2, 15)
